...
int main() {
  ...
  Mat trainDescriptor;
  Ptr<xfeatures2d::SurfFeatureDetector> featureDetector =
      xfeatures2d::SurfFeatureDetector::create(80);
  featureDetector->detect(trainImage_gray, train_keyPoint);
  featureDetector->compute(trainImage_gray, train_keyPoint, trainDescriptor);
  ...
  while (char(waitKey(1)) != 'q') {
    ...
    //<6>绘制匹配点并显示窗口
    Mat dstImage;
    drawMatches(testImage, test_keyPoint, trainImage, train_keyPoint,
